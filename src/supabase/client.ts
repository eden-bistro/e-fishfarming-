...
export const supabaseUrl = (env.VITE_SUPABASE_URL ?? env.SUPABASE_URL ?? "").trim();
export const supabaseAnonKey = (env.VITE_SUPABASE_ANON_KEY ?? env.SUPABASE_ANON_KEY ?? "").trim();
